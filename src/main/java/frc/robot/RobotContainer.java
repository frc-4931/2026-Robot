...
public class RobotContainer
{
  ...
  private final ShootWhileMoving shootwhilemoving = new ShootWhileMoving(drivebase, null, driverXbox, null);
...
//                              );
    ...
    } else
    {
      ...
      driverXbox.rightBumper().onTrue(Commands.none());
      driverXbox.rightTrigger().whileTrue(Commands.parallel(shootwhilemoving));
    }
